# 1 - Create a variable called numbers which is a tuple with the the values 1, 2, 3
# and 4 inside.
...
# Create a variable called unique_stuff which is a set of only the unique values
#in the stuff list

unique_stuff = set(stuff)

[print(x) for x in unique_stuff]
